...
$data = [
	...
	"intergratedTeamList"=>["page"=>1,"page_size"=>10,"fields"=>'tid,team_name,logo',"game"=>$config['game'],"rand"=>1,"cacheWith"=>"currentPage","cache_time"=>86400*7],
    ...
    "currentPage"=>["name"=>"intergratedPlayerList","site_id"=>$config['site_id'],"page"=>$page],
];
...
<div class="container">
  ...
  <div class="xs_lb">
    ...
    <div class="xs_nr">
      <ul class="row">
        <?php foreach($return['intergratedPlayerList']['data'] as $player){?>
            <li>
                <div class="t_p"><a href="<?php echo $config['site_url']."/player/".$player['pid'];?>">
