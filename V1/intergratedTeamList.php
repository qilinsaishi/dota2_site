...
$data = [
	...
	"intergratedTeamList"=>["page"=>$page,"page_size"=>$info['page']['page_size'],"fields"=>'tid,team_name,logo',"game"=>$config['game'],"cacheWith"=>"currentPage","cache_time"=>0],
    ...
    "currentPage"=>["name"=>"intergratedTeamList","site_id"=>$config['site_id'],"page"=>$page]
];
...
<div class="container">
  ...
  <div class="zd_lb">
    ...
    <div class="zd_nr">
      <ul class="row">
        <?php foreach($return['intergratedTeamList']['data'] as $team){?>
            <li>
